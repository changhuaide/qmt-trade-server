...
> **提示**
>
> 盘中分笔驱动，但是逐 K 线生效。请参考[常见问题：系统对象ContextInfo 逐K线保存的机制](https://dict.thinktrader.net/innerApi/question_answer.html#系统对象-contextinfo-逐-k-线保存的机制)
...
回测的操作流程请参考：[界面操作-策略回测](https://dict.thinktrader.net/innerApi/interface_operation.html#策略回测)
...
**基础信息设置** 请参考[基础信息-字段描述](https://dict.thinktrader.net/innerApi/interface_operation.html#基本信息-字段描述)

**回测参数设置** 请参考[回测参数-字段描述](https://dict.thinktrader.net/innerApi/interface_operation.html#回测参数-字段描述)

### 实盘示例-基于 handlebar

实盘的操作流程请参考：[界面操作-模型交易](https://dict.thinktrader.net/innerApi/interface_operation.html#策略运行)
...
> **危险**
>
> 对于立刻下单的模型需要用普通的全局变量来保存状态不能ContextInfo对象存详细说明参考[常见问题：系统对象ContextInfo 逐K线保存的机制](https://dict.thinktrader.net/innerApi/question_answer.html#系统对象-contextinfo-逐-k-线保存的机制)
