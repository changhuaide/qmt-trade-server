...
| `openInt` | `float` | `若是股票，则openInt含义为股票状态，非股票则是持仓量`[openInt字段说明](https://dict.thinktrader.net/innerApi/data_structure.html#openint-证券状态) |
...
| volume | int | 委托量 |
| entrustNo | int | 委托号 |
| entrustType | int | [委托类型](https://dict.thinktrader.net/innerApi/data_structure.html#entrusttype-委托类型) |
...
| m_nDirection | int | [EEntrustBS 类型，操作，多空，期货多空，股票买卖永远是 48，其他的 dir 同理](https://dict.thinktrader.net/innerApi/enum_constants.html#enum-eentrustbs-买卖方向) |
| m_nOffsetFlag | int | [EOffset_Flag_Type类型，买卖/开平，用此字段区分股票买卖，期货开、平仓，期权买卖等](https://dict.thinktrader.net/innerApi/enum_constants.html#enum-eoffset-flag-type-操作类型) |
...
| m_nOrderSubmitStatus | int | [EEntrustSubmitStatus 类型，报单状态，提交状态，股票中不需要报单状态](https://dict.thinktrader.net/innerApi/enum_constants.html#eentrustsubmitstatus-报单状态) |
| m_strOrderSysID | str | 合同编号，委托号 |
| m_nOrderStatus | int | [EEntrustStatus，委托状态](https://dict.thinktrader.net/innerApi/enum_constants.html#enum-eentruststatus-委托状态) |
...
| m_eEntrustType | int | [EEntrustTypes，委托类别](https://dict.thinktrader.net/innerApi/enum_constants.html#enum-eentrusttypes-委托类型) |
...
| m_eCashgroupProp | int | [EXTCompactBrushSource类型，头寸来源](https://dict.thinktrader.net/innerApi/enum_constants.html#enum-extcompactbrushsource-头寸来源) |
...
> **提示**
>
> 由于字段m_dSloRatio、m_dSloStatus提供来源和取担保品明细**get_assure_contract**重复，字段在2021年9月移除，后续用担保品明细接口获取,具体见 [担保标的对象字段说明在新窗口打开](https://dict.thinktrader.net/innerApi/data_structure.html#stksubjects-%E6%8B%85%E4%BF%9D%E6%A0%87%E7%9A%84%E5%AF%B9%E8%B1%A1)
