...
- `period`周期为Level2数据时，字段参考[数据结构](https://dict.thinktrader.net/innerApi/data_structure.html#l2quote-level2行情快照)
...
> 2. VIP用户支持全推市场指定周期K线
> 3. VIP用户权限请参考[vip-行情用户优势对比](https://dict.thinktrader.net/dictionary/#vip-行情用户优势对比)
...
> **危险**
>
> 1. 此函数已不推荐使用，推荐使用[ContextInfo.get_market_data_ex()在新窗口打开](https://dict.thinktrader.net/innerApi/data_function.html#contextinfo-get-market-data-ex-%E8%8E%B7%E5%8F%96%E8%A1%8C%E6%83%85%E6%95%B0%E6%8D%AE)
> 2. 此函数使用前需要先通过[ContextInfo.set_universe()]()设定股票池
